...
app.factory('ChartService', ['$http', '$q', '$mdToast', 'Model', 'utils',
    function($http, $q, $mdToast, Model, utils) {
        var service = this;
        window.aaa = service;
        ...
        service.updateData = function (categoryId) {
            service.getStatisticsForCategory(categoryId).then(function(r) {
                var data = service.convertResponseToChartData(r);
